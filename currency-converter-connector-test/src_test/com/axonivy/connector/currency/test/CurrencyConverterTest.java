...
import com.axonivy.connector.currency.utils.CurrencyConverterTestUtils;
...
public class CurrencyConverterTest {
	...
	void beforeEach(ExtensionContext context, AppFixture fixture) {
		CurrencyConverterTestUtils.setUpConfigForContext(context.getDisplayName(), fixture);
	}

	@TestTemplate
	void chfToEur(ExtensionContext context, BpmClient bpmClient) throws NoSuchFieldException {
		boolean isRealContext = context.getDisplayName().equals(CurrencyConverterTestConstant.REAL_CALL_CONTEXT_DISPLAY_NAME);
